...
import { Box, Button, Card, CardContent, Collapse, Divider, Stack, TextField, Typography } from "@mui/material";
            ...
            <div className="adminPage">
                <Box className="adminWindow">
                    ...
                    <div className="adminContent">
                        ...
                        <Card className="adminSideCard" sx={{
                            bgcolor: "#151922",
                            color: "white",
                            borderRadius: "32px",
                            ...
                            <CardContent sx={{ p: 3, "&:last-child": { pb: 3 } }}>
                                ...
                                <Typography sx={{ color: "#8f94a3", mb: 2 }}>
                                    Введите user_id покупателя для просмотра заказов
                                </Typography>

                                <TextField fullWidth type="number" label="user_id" value={orderUserId}
                                        onChange={(event) => setOrderUserId(event.target.value)}
                                        sx={{mb: 2, input: {color: "white",}, label: {color: "#8f94a3",},
                                            "& label.Mui-focused": {color: "#8f94a3",},
                                ...
                                {orderUserId ? (
                                        <OrderList userId={Number(orderUserId)} />
                                ) : (
                                        <Typography sx={{ color: "#8f94a3" }}>
                                            Укажите user_id, чтобы загрузить заказы
                                        </Typography>
                                )}
                            </CardContent>
                        </Card>
